...
def main():
    ...
    if exp == None:
        print(f'No such active experiment found, starting experiment {experiment_name}')
    ...
    with mlflow.start_run():
        ...
        df = pd.read_csv('/Users/aaryadevchandra/Programming/mlops-workspace/mlflow-workspace/Obesity Classification.csv')
